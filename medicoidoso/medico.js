document.addEventListener("DOMContentLoaded", () => {
    ...
    modalAjuda.innerHTML = `
        <div class="conteudo-ajuda">
            ...
            <p>Aqui você pode conversar com um médico caso esteja se sentindo mal</p>
            <p> <strong>você pode digitar ou gravar um aúdio contando o que está sentindo, apenas siga as instruções. </strong></p>
